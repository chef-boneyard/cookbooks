...
require File.join(File.dirname(__FILE__), 'provider_windows_feature')

class Chef
  class Provider
    class WindowsFeature
      class DISM < Chef::Provider::WindowsFeature

        def load_current_resource
          @current_resource = Chef::Resource::WindowsFeature.new(@new_resource.name)
