...
#
description "riak/kv/storage_backend_options/riak_kv_dets_backend_root"
...
#
description "riak/kv/storage_backend_options/writes_per_fsync"
  :display_name => "Writes per fsync",
  :description => "Number of write operations before forcing an fsync.",
  :default => "1"

description "riak/kv/storage_backend_options/data_root"
  :display_name => "Data root directory",
  :description => "Directory where the data files will be stored.",
