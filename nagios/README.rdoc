...
Installs and configures Nagios 3 for a server and for clients using Chef 0.8 search capabilities. Also can setup nsca client for passive checks.
...
nsca.config - Where the send_nsca.cfg file is stored
nsca.package - nsca package name
nsca.password
nsca.encryption_method
nsca.port
