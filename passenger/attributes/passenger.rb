...
passenger[:version]          = "2.1.2" unless passenger.has_key?(:version)
...
passenger[:apache_load_path] = "#{apache[:dir]}/mods-available/passenger.load"
passenger[:apache_conf_path] = "#{apache[:dir]}/mods-available/passenger.conf"
