...
* redmine[:db][:hostname] - hostname of database server, default is the first node with attribute database_master true.
...
You'll probably want to customize it to fit your environment, as a site-cookbook, especially if you want to use something besides sqlite as the database backend.
