...
Ubuntu is best supported. Debian may work. CentOS and Red Hat are not fully supported, but we take patches.
...
This will get the required packages and configuration for client systems 
...
Change the rootpw directive in slapd.conf.erb for your site. The default is a random 16 character string. 
