...
default['haproxy']['add_x_forwarded_for'] = false # Creates an X-Forwarded-For header containing the original client's IP address. Without this, the client's IP address will be lost (not available to app server) when it is replaced with that of haproxy. This option disables KeepAlive.
